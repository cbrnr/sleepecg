...
from sleepecg import get_config, get_config_key, set_config
...
def test_get_set_del_config():
    ...
    assert get_config_key("data_dir") == "~/.sleepecg/datasets"
    assert get_config_key("classifiers_dir") == "~/.sleepecg/classifiers"
    set_config(data_dir="some_dir")
    assert get_config_key("data_dir") == "some_dir"
    assert get_config_key("classifiers_dir") == "~/.sleepecg/classifiers"
